...
/* lyc: 消费根选项令牌
  只关注 --dev, --no-color, --profile, --log-level, --container 这些根选项 其它一律返回0
  也只包括内联选项: --profile=, --log-level=, --container=
*/
export function consumeRootOptionToken(args: ReadonlyArray<string>, index: number): number {
  ...
  // lyc: 当前参数是值参数根选项, --profile, --log-level, --container, 且下一个参数是值参数, 消费令牌数为2, 即代表消费当前参数和下一个参数
